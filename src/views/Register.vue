    ...
    <div class="login-box">
      <div
        ...
        <el-form ref="formRef" :rules="data.rules" :model="data.form" style="width: 300px">
          <div style="margin-bottom: 30px;font-size: 24px;text-align: center; color:blue;font-weight:bold">欢 迎 注 册
          </div>
          ...
          <div style="text-align: right">已有账号?请<a style="color: #0742b1;text-decoration: none" href="/login">登 录</a>
          </div>
        </el-form>
      </div>
